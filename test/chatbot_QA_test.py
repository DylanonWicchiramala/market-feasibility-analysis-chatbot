...
results, exet_rept = API_test(quesion_test, num_samples=12, result_save_path='test/testset/api_QA_test_result.txt', endpoint=endpoint); utils.notify("aurora")
# results, exet_rept = QA_sample_test(quesion_test, num_samples=12, result_save_path="test/testset/QA_test_result.txt"); utils.notify("aurora")